import { stringCalculatorV1, stringCalculatorV2, stringCalculatorV3 } from '../core/stringCalculator';
...
describe('String Calculator version 3 should', () => {
  it('return 0 for an empty text', () => {
  ...
  it('return the sum for only numbers and ignore letters or symbols', () => {
    expect(stringCalculatorV3('5,6,a3')).toBe(11);
    expect(stringCalculatorV3('5,6,a,3')).toBe(14);
  });
  it('return the sum for numbers separated by a symbol indicated as an input', () => {
    expect(stringCalculatorV3('5*6*4a', '*')).toBe(11);
    expect(stringCalculatorV3('5*6*,4a', '*')).toBe(11);
    expect(stringCalculatorV3('5*6*,4', '*')).toBe(11);
  });
  it('return 0 for text without numbers', () => {
    expect(stringCalculatorV3('b')).toBe(0);
    expect(stringCalculatorV3('b,d')).toBe(0);
  });
});